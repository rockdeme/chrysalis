...
from chrysalis.optimizers.nnls import nnls_transform, nnls_fit_transform
from chrysalis.optimizers.frank_wolfie import frank_wolfe_transform, frank_wolfe_fit_transform
...
class AA(TransformerMixin, BaseEstimator):
    ...
    _parameter_constraints: dict = {
        ...
        "init": [StrOptions({"uniform", "furthest_sum", "furthest_first", "coreset", "aa_plus_plus"}), None,],
        "init_kwargs": [dict, None],
        "save_init": [bool],
        "method": [StrOptions({"nnls", "FW"})],
        "method_kwargs": [dict, None],
        "random_state": ["random_state"],
        "verbose": ["verbose"],
    }

    def __init__(self, n_archetypes, *, max_iter=300, tol=1e-4, init="uniform", n_init=1, init_kwargs=None,
                 save_init=False, method="nnls", method_kwargs=None, verbose=False, random_state=None):
    ...
    def transform(self, X):
        ...
        if self.method == "nnls":
            ...
            transform_func = frank_wolfe_transform
    ...
    def fit_transform(self, X, y=None):
        ...
        if self.n_archetypes == 1:
            ...
            if self.method == "nnls":
                ...
                fit_transform_func = frank_wolfe_fit_transform
