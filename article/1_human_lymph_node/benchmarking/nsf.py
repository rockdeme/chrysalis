...
ad = sc.datasets.visium_sge(sample_id='V1_Human_Lymph_Node')

ad.var_names_make_unique()
sc.pp.calculate_qc_metrics(ad, inplace=True)
sc.pp.filter_cells(ad, min_counts=6000)
...
mpth = path.join("/mnt/c/Users/demeter_turos/PycharmProjects/deep_learning/nsf/models/V5")
...
file = open(mpth + '/human_lymph_node_nsf.pkl', 'wb')
pickle.dump({'factors': insf, 'positions': Xtr}, file)
file.close()

file = open(mpth + '/human_lymph_node_nsf.pkl', 'rb')
